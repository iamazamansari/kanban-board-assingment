...
const Card = (props) => {
  const logoReference = {
    Backlog: (
      <img
        src="https://cdn-icons-png.flaticon.com/128/10905/10905332.png"
        className="logo-pic"
        alt="Backlog"
      />
    ),
    ...
    "In progress": (
      <img
        src="https://cdn-icons-png.flaticon.com/128/5460/5460873.png"
        className="logo-pic"
        alt="In progress"
      />
    ),
    Done: (
      <img
        src="https://cdn-icons-png.flaticon.com/128/5461/5461184.png"
        className="logo-pic"
        alt="Done"
      />
    ),
    Cancelled: (
      <img
        src="https://cdn-icons-png.flaticon.com/128/1008/1008968.png"
        className="logo-pic"
        alt="Cancelled"
      />
    ),
  ...
  return (
    <div className="card">
      ...
      <div className="card-middle">
        ...
        <p className="card-desc bold">{props.ticket.title}</p>
      </div>
